...
@section('content')
    ...
    <div class="flex flex-row bg-white w-[85%] mb-[0.5vh] mt-[2vh] rounded-sm">
        ...
        <input type="password" name="password" placeholder="Your Password" class="rounded-sm w-[76%] focus:outline-none focus:border-[#04326A] focus:ring-[#04326A] focus:ring-1 px-3">
    ...
    <div class="flex flex-row bg-white w-[85%] mb-[2vh] mt-[2vh] rounded-sm">
        ...
        <input type="password" name="password2" placeholder="Confirm Your Password" class="rounded-sm w-[76%] focus:outline-none focus:border-[#04326A] focus:ring-[#04326A] focus:ring-1 px-3">
        <button class="w-[12%] block p-2" id="show2">
            <img src="{{ asset('assets/logo/show.png') }}" alt="show">
        </button>
        <button class="w-[12%] p-2 hidden" id="hide2">
            <img src="{{ asset('assets/logo/hide.png') }}" alt="hide">
        </button>
    </div>
    <div class="mt-[1vh] flex flex-row">
        <div class="mr-[0.25vw]">Already have an account?</div>
        <div class="font-medium tracking-tight text-[#FFC533]"><a href="{{ '/login' }}">Log In</a></div>
